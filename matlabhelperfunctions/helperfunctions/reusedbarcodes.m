...
load('barcodematrixM194_EI.mat')       % load mapseq data

num_brain = 6;     % 10 brains in total
...
idx_injection{1} = 117:119;
idx_injection{2} = 120:122;
idx_injection{3} = 123:125;
idx_injection{4} = 126:128;
idx_injection{5} = 129:131;
idx_injection{6} = 132:134;
