...
if exist('ratiothreshold','var')
    ...
    [sourcemax,source]=max(Bnorm_source,[],2);
    ...
    source=source(ratio(:,2)<ratiothreshold);
...
save('filtBC.mat','B_tar','Bnorm_tar','B','Bnorm','Bseq','spikes','totalBnorm_tar','maxBnorm_tar','source','filter1','filter2');