load('barcodematrixL1M194_EI.mat');    % Load L1 matrix
load('barcodematrixM194_EI.mat');      % load L2 matrix
load('spikesM194_EI.mat');  % load spike in
target_L2 = 1:114; %change target site info
target_L1 = 115; %change L1 target site info
