function [aligned_r1,aligned_c1,aligned_r2,aligned_c2,aligned1,aligned2]=projrange2(data1,data2,sourceColors)
...
aligned1=zeros(size(data1,1),5);
aligned2=zeros(size(data2,1),5);
...
for i=1:size(data1,1)
    ...
    if (idx1(i)>=3) && (idx1(i)<=(size(data1,2)-2))
        aligned1(i,5)=data1(i,idx1(i)+2);
        aligned1(i,4)=data1(i,idx1(i)+1);
        aligned1(i,3)=data1(i,idx1(i));
        aligned1(i,2)=data1(i,idx1(i)-1);
        aligned1(i,1)=data1(i,idx1(i)-2);
    end
    if idx1(i)>=5
...
for i=1:size(data2,1)
    if (idx2(i)>=3) && (idx2(i)<=(size(data2,2)-2))
        aligned2(i,5)=data2(i,idx2(i)+2);
        aligned2(i,4)=data2(i,idx2(i)+1);
        aligned2(i,3)=data2(i,idx2(i));
        aligned2(i,2)=data2(i,idx2(i)-1);
        aligned2(i,1)=data2(i,idx2(i)-2);
    end
    if idx2(i)>=5
