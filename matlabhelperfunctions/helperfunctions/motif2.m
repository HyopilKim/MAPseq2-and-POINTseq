function motif2(matrix,targetlabels,cutoff,cut_relativeobs,min_region,min_cts,p_adjP,maxtar,N_t,volcanoplotsize,volcanodotlabel,doeachneuron)
...
if min(pre_relative_obs)==0
    minrelobs=log2(1/max(pre_relative_obs));
