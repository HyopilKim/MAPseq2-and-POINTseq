...
function conditionalPmotif(matrix,targetlabels1,targetlabels2,cutoff,min_region,min_cts,maxtar,plot,dolabel,doN_t)
...
Plabels=targetlabels1(sum(matrix_binary_tmp,1)>min_region);
...
save('contionalPmotif.mat','conditionalp','matrix_binary','N_t','numerator','signifP','coE','coO','obs','esti','p_adjP','p_adjM','signifM','relative_obs','Pconnected_motif_asidx','Pconnected_motif_aslabel','coRegions');