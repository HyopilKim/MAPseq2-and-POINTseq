...
MATLAB
No installation is required. Download the functions from GitHub:
...
Example raw barcode matrices and projection matrices are provided in the same directory and can also be used for the demo.
